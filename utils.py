...
# ✅ FILTRO GLOBAL DE SÍMBOLOS PROIBIDOS
ELITE_SYMBOLS = [s for s in ELITE_SYMBOLS if s not in config.FORBIDDEN_SYMBOLS]
OPORTUNIDADE_SYMBOLS = [s for s in OPORTUNIDADE_SYMBOLS if s not in config.FORBIDDEN_SYMBOLS]
